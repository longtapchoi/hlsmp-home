...
public final class HomesMenu {
   ...
   private static ItemStack teamHome() {
      return namedItem(Material.WHITE_BANNER, "&bɴʜà ɴʜóᴍ", List.of("&fClick để dịch chuyển đến ɴʜà ɴʜóᴍ"), "team-home", null);
   }

   private static ItemStack deleteTeamHome() {
      return namedItem(Material.BLUE_DYE, "&bxóᴀ", List.of("&fClick để xóa nhà nhóm"), "delete-team-home", null);
   }
